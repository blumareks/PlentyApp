		...
		com.worklight.wlclient.WLRequestListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Worklight.Xamarin.Android.RequestListener, Worklight.Xamarin.Android, Version=7.1.0.1, Culture=neutral, PublicKeyToken=null", RequestListener.class, __md_methods);
	}


	public RequestListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == RequestListener.class)
			mono.android.TypeManager.Activate ("Worklight.Xamarin.Android.RequestListener, Worklight.Xamarin.Android, Version=7.1.0.1, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
